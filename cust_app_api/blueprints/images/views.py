...
@images_api_blueprint.route('/upload/<order_id>', methods=['GET'])
...
@images_api_blueprint.route('/upload/<order_id>', methods=['PUT'])
...
@images_api_blueprint.route('/upload/<order_id>', methods=['DELETE'])
